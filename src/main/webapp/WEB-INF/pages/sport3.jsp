...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121964/32.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport3like" var="sport3likeUrl"/>
        <form action="${sport3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport3dislike" var="sport3dislikeUrl"/>
        <form action="${sport3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121964/32.jpg.html?a=download">3156x1766</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121963/31.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121966/34.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img42/3130153/33.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

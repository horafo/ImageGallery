...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118862/34.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto3like" var="auto3likeUrl"/>
        <form action="${auto3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto3dislike" var="auto3dislikeUrl"/>
        <form action="${auto3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li><a href="http://www.imageup.ru/img226/3118862/34.jpg.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118858/31.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118859/32.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118860/33.jpg.html?a=download ">1280x720</a></li>
                </ul>
            </li>
        </ul>
    </div>

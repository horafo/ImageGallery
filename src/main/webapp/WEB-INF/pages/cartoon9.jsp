...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121847/91.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon9like" var="cartoon9likeUrl"/>
        <form action="${cartoon9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon9dislike" var="cartoon9dislikeUrl"/>
        <form action="${cartoon9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121847/91.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121848/92.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121850/94.jpg.html?a=download">1344x756</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121849/93.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118978/261.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto26like" var="auto26likeUrl"/>
        <form action="${auto26likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto26dislike" var="auto26dislikeUrl"/>
        <form action="${auto26dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118978/261.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118980/263.jpg.html?a=download">1600x1000</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118981/264.jpg.html?a=download">1200x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118979/262.jpg.html?a=download ">1024x628</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122267/91.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals9like" var="animals9likeUrl"/>
        <form action="${animals9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals9dislike" var="animals9dislikeUrl"/>
        <form action="${animals9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122267/91.jpg.html?a=download">4256x2832</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122268/92.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122270/94.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122269/93.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

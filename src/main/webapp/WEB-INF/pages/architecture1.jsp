...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119575/11.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture1like" var="architecture1likeUrl"/>
        <form action="${architecture1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture1dislike" var="architecture1dislikeUrl"/>
        <form action="${architecture1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119575/11.jpg.html?a=download">2560x1920</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119576/12.jpg.html?a=download">1920x1440</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119578/14.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119577/13.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

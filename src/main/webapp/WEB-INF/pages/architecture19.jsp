...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119656/192.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture19like" var="architecture19likeUrl"/>
        <form action="${architecture19likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture19dislike" var="architecture19dislikeUrl"/>
        <form action="${architecture19dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119656/192.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119653/191.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119655/193.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119657/194.jpg.html?a=download ">1366x768</a>
                    </li>
                </ul>
            </li>
        </ul>

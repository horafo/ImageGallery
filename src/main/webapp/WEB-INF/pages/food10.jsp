...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121658/102.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food10like" var="food10likeUrl"/>
        <form action="${food10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food10dislike" var="food10dislikeUrl"/>
        <form action="${food10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121658/102.jpg.html?a=download">2580x1720</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121657/101.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121660/104.jpg.html?a=download">1400x933</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121659/103.jpg.html?a=download ">1200x800</a>
                    </li>
                </ul>
            </li>
        </ul>

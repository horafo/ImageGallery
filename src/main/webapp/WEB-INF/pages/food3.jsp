...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121628/31.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food3like" var="food3likeUrl"/>
        <form action="${food3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food3dislike" var="food3dislikeUrl"/>
        <form action="${food3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121628/31.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121629/32.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121631/34.jpg.html?a=download">1080x675</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121630/33.jpg.html?a=download ">284x177</a>
                    </li>
                </ul>
            </li>
        </ul>

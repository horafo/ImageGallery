...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121632/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food4like" var="food4likeUrl"/>
        <form action="${food4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food4dislike" var="food4dislikeUrl"/>
        <form action="${food4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121632/41.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121634/43.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121635/44.jpg.html?a=download">1200x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121633/42.jpg.html?a=download ">284x177</a>
                    </li>
                </ul>
            </li>
        </ul>

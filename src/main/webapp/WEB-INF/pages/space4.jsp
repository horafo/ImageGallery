...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121758/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space4like" var="space4likeUrl"/>
        <form action="${space4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space4dislike" var="space4dislikeUrl"/>
        <form action="${space4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121758/41.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121759/42.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121761/44.jpg.html?a=download">1200x675</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121760/43.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

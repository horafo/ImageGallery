...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121816/22.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon2like" var="cartoon2likeUrl"/>
        <form action="${cartoon2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon2dislike" var="cartoon2dislikeUrl"/>
        <form action="${cartoon2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121816/22.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121815/21.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121817/23.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121818/24.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

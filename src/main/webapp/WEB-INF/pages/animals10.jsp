...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122272/102.jpg"></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals10like" var="animals10likeUrl"/>
        <form action="${animals10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals10dislike" var="animals10dislikeUrl"/>
        <form action="${animals10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122272/102.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122271/101.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122274/104.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122273/103.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

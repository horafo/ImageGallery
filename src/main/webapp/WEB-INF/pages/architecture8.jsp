...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119607/81.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture8like" var="architecture8likeUrl"/>
        <form action="${architecture8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture8dislike" var="architecture8dislikeUrl"/>
        <form action="${architecture8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119607/81.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119608/82.jpg.html?a=download">1600x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119610/84.jpg.html?a=download">1360x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119609/83.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

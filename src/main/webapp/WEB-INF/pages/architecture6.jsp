...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119600/62.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture6like" var="architecture6likeUrl"/>
        <form action="${architecture6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture6dislike" var="architecture6dislikeUrl"/>
        <form action="${architecture6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119600/62.jpg.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119599/61.jpg.html?a=download">2560x1440</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119601/63.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119602/64.jpg.html?a=download ">1366x768</a>
                    </li>
                </ul>
            </li>
        </ul>

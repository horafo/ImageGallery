...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121681/11.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film1like" var="film1likeUrl"/>
        <form action="${film1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film1dislike" var="film1dislikeUrl"/>
        <form action="${film1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121681/11.jpg.html?a=download">3080x1723</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121682/12.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121683/13.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121684/14.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

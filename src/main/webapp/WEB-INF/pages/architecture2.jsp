...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119580/22.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture2like" var="architecture2likeUrl"/>
        <form action="${architecture2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture2dislike" var="architecture2dislikeUrl"/>
        <form action="${architecture2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119580/22.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119579/21.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119582/24.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119581/23.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

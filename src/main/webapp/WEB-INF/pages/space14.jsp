...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121802/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space14like" var="space14likeUrl"/>
        <form action="${space14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space14dislike" var="space14dislikeUrl"/>
        <form action="${space14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121802/141.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121804/143.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121803/142.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121805/144.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

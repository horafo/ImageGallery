...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118887/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto10like" var="auto10likeUrl"/>
        <form action="${auto10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto10dislike" var="auto10dislikeUrl"/>
        <form action="${auto10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118887/101.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118888/102.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118890/104.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118889/103.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

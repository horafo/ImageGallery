...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121560/31.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games3like" var="games3likeUrl"/>
        <form action="${games3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games3dislike" var="games3dislikeUrl"/>
        <form action="${games3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121560/31.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121561/32.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121563/34.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121562/33.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

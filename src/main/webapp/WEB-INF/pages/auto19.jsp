...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118926/192.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto19like" var="auto19likeUrl"/>
        <form action="${auto19likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto19dislike" var="auto19dislikeUrl"/>
        <form action="${auto19dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118926/192.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118925/191.jpg.html?a=download">1920x1380</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118927/193.jpeg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118928/194.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

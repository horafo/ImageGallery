...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121958/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport2like" var="sport2likeUrl"/>
        <form action="${sport2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport2dislike" var="sport2dislikeUrl"/>
        <form action="${sport2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121958/21.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121959/22.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121960/23.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121961/24.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

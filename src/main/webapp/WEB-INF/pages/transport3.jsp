...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122307/34.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport3like" var="transport3likeUrl"/>
        <form action="${transport3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport3dislike" var="transport3dislikeUrl"/>
        <form action="${transport3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122307/34.jpg.html?a=download">2048x1358</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122304/31.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122305/32.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122306/33.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

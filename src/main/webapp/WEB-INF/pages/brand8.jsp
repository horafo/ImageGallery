...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121519/82.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand8like" var="brand8likeUrl"/>
        <form action="${brand8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand8dislike" var="brand8dislikeUrl"/>
        <form action="${brand8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121519/82.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121518/81.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121522/84.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121521/83.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

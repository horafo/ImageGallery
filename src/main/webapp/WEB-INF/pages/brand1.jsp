...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121484/11.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand1like" var="brand1likeUrl"/>
        <form action="${brand1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand1dislike" var="brand1dislikeUrl"/>
        <form action="${brand1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121484/11.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121488/14.jpeg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121485/12.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121487/13.jpg.html?a=download ">1024x819</a>
                    </li>
                </ul>
            </li>
        </ul>

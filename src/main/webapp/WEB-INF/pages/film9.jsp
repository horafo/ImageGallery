...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121715/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film9like" var="film9likeUrl"/>
        <form action="${film9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film9dislike" var="film9dislikeUrl"/>
        <form action="${film9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121715/91.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121718/94.jpg.html?a=download">1700x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121717/93.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121716/92.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

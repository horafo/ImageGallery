...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121569/52.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games5like" var="games5likeUrl"/>
        <form action="${games5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games5dislike" var="games5dislikeUrl"/>
        <form action="${games5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121569/52.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121568/51.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121570/53.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121571/54.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

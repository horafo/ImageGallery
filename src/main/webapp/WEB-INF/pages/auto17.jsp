...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118918/172.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto17like" var="auto17likeUrl"/>
        <form action="${auto17likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto17dislike" var="auto17dislikeUrl"/>
        <form action="${auto17dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118918/172.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118917/171.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118919/173.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118920/174.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121768/62.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space6like" var="space6likeUrl"/>
        <form action="${space6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space6dislike" var="space6dislikeUrl"/>
        <form action="${space6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121768/62.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121767/61.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121769/63.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121770/64.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

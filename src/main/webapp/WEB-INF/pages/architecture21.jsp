...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119662/211.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture21like" var="architecture21likeUrl"/>
        <form action="${architecture21likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture21dislike" var="architecture21dislikeUrl"/>
        <form action="${architecture21dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119662/211.jpg.html?a=download">2304x1536</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119663/212.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119664/213.jpg.html?a=download">1280x853</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119665/214.jpg.html?a=download ">1024x683</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121934/122.jpeg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature12like" var="nature12likeUrl"/>
        <form action="${nature12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature12dislike" var="nature12dislikeUrl"/>
        <form action="${nature12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121934/122.jpeg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121933/121.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121936/124.jpg.html?a=download">1600x1200</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121935/123.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

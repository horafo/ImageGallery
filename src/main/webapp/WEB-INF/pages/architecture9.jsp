...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119612/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture9like" var="architecture9likeUrl"/>
        <form action="${architecture9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture9dislike" var="architecture9dislikeUrl"/>
        <form action="${architecture9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119612/91.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119615/94.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119613/92.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119614/93.jpg.html?a=download ">1000x667</a>
                    </li>
                </ul>
            </li>
        </ul>

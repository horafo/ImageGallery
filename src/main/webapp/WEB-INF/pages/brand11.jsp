...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121532/111.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand11like" var="brand11likeUrl"/>
        <form action="${brand11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand11dislike" var="brand11dislikeUrl"/>
        <form action="${brand11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121532/111.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121533/112.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121534/113.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121535/114.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

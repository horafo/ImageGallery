...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121889/32.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature3like" var="nature3likeUrl"/>
        <form action="${nature3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature3dislike" var="nature3dislikeUrl"/>
        <form action="${nature3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121889/32.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121888/31.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121890/33.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121891/34.jpeg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

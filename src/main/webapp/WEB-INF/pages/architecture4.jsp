...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119587/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture4like" var="architecture4likeUrl"/>
        <form action="${architecture4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture4dislike" var="architecture4dislikeUrl"/>
        <form action="${architecture4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119587/41.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119591/44.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119589/42.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119590/43.jpg.html?a=download ">1280x720 </a>
                    </li>
                </ul>
            </li>
        </ul>

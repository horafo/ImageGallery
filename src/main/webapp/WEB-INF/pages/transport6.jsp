...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122303/24.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport6like" var="transport6likeUrl"/>
        <form action="${transport6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport6dislike" var="transport6dislikeUrl"/>
        <form action="${transport6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122317/62.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122316/61.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122318/63.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122319/64.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

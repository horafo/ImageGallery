...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121851/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon10like" var="cartoon10likeUrl"/>
        <form action="${cartoon10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon10dislike" var="cartoon10dislikeUrl"/>
        <form action="${cartoon10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121855/103.jpg.html?a=download">4500x1863</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121851/101.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121852/102.jpg.html?a=download">1280x528</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121856/104.jpg.html?a=download ">822x548</a>
                    </li>
                </ul>
            </li>
        </ul>

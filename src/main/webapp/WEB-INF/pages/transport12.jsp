        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <form class="navbar-form navbar-right">
                <div class="form-group" id="enter">
                    <a href="/login" class="btn btn-success btn-lg" class="form-control">Вхід/Особистий кабінет</a>
                </div>
...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122341/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport12like" var="transport12likeUrl"/>
        <form action="${transport12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport12dislike" var="transport12dislikeUrl"/>
        <form action="${transport12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122341/121.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122344/124.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122342/122.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122343/123.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

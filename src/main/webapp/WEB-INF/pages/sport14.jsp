...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122017/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport14like" var="sport14likeUrl"/>
        <form action="${sport14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport14dislike" var="sport14dislikeUrl"/>
        <form action="${sport14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122017/141.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122018/142.jpg.html?a=download">1920x1440</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122019/143.jpg.html?a=download">1440x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122020/144.jpg.html?a=download ">1280x900</a>
                    </li>
                </ul>
            </li>
        </ul>

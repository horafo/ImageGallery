...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121841/81.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon8like" var="cartoon8likeUrl"/>
        <form action="${cartoon8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon8dislike" var="cartoon8dislikeUrl"/>
        <form action="${cartoon8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121841/81.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121843/82.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121846/84.jpg.html?a=download">1500x1120</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121845/83.png.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

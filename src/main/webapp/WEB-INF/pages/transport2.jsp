...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport2like" var="transport2likeUrl"/>
        <form action="${transport2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport2dislike" var="transport2dislikeUrl"/>
        <form action="${transport2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122303/24.jpg.html?a=download">2048x1365</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122300/21.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122301/22.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122302/23.jpg.html?a=download ">650x434</a>
                    </li>
                </ul>
            </li>
        </ul>

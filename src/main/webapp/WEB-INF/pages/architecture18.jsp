...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119650/182.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture18like" var="architecture18likeUrl"/>
        <form action="${architecture18likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture18dislike" var="architecture18dislikeUrl"/>
        <form action="${architecture18dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119650/182.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119649/181.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119651/183.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119652/184.jpg.html?a=download ">1366x768</a>
                    </li>
                </ul>
            </li>
        </ul>

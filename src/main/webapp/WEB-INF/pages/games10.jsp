...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121588/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games10like" var="games10likeUrl"/>
        <form action="${games10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games10dislike" var="games10dislikeUrl"/>
        <form action="${games10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121588/101.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121591/104.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121589/102.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121590/103.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

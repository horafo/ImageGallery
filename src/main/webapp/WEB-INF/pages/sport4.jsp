...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121969/42.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport4like" var="sport4likeUrl"/>
        <form action="${sport4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport4dislike" var="sport4dislikeUrl"/>
        <form action="${sport4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121969/42.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121968/41.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121970/43.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121971/44.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

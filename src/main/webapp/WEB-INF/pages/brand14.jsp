...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121544/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand14like" var="brand14likeUrl"/>
        <form action="${brand14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand14dislike" var="brand14dislikeUrl"/>
        <form action="${brand14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121544/141.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121545/142.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121546/143.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121547/144.jpg.html?a=download ">1137x900</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121608/142.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games14like" var="games14likeUrl"/>
        <form action="${games14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games14dislike" var="games14dislikeUrl"/>
        <form action="${games14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121608/142.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121607/141.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121609/143.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121611/144.jpg.html?a=download ">1024x623</a>
                    </li>
                </ul>
            </li>
        </ul>

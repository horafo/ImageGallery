...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119630/132.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture13like" var="architecture13likeUrl"/>
        <form action="${architecture13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture13dislike" var="architecture13dislikeUrl"/>
        <form action="${architecture13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119630/132.jpg.html?a=download">2560x1700</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119629/131.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119632/134.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119631/133.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

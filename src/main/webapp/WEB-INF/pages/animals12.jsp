...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122279/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals12like" var="animals12likeUrl"/>
        <form action="${animals12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals12dislike" var="animals12dislikeUrl"/>
        <form action="${animals12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122279/121.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122281/123.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122282/124.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122280/122.jpg.html?a=download ">1000x625</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122238/31.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals3like" var="animals3likeUrl"/>
        <form action="${animals3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals3dislike" var="animals3dislikeUrl"/>
        <form action="${animals3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122238/31.jpg.html?a=download">3160x2000</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122239/32.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122241/34.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122240/33.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

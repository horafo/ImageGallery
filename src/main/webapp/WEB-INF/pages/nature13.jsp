...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121939/131.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature13like" var="nature13likeUrl"/>
        <form action="${nature13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature13dislike" var="nature13dislikeUrl"/>
        <form action="${nature13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121939/131.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121942/134.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121940/132.jpghtml?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121941/133.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122288/142.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals14like" var="animals14likeUrl"/>
        <form action="${animals14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals14dislike" var="animals14dislikeUrl"/>
        <form action="${animals14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122287/141.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122288/142.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122290/144.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122289/143.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

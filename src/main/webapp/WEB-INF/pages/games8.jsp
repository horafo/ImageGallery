...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121580/81.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games8like" var="games8likeUrl"/>
        <form action="${games8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games8dislike" var="games8dislikeUrl"/>
        <form action="${games8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121580/81.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121583/84.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121581/82.jpg.html?a=download">1024x576</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121582/83.jpg.html?a=download ">930x580</a>
                    </li>
                </ul>
            </li>
        </ul>

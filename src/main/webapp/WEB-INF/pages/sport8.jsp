...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121989/81.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport8like" var="sport8likeUrl"/>
        <form action="${sport8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport8dislike" var="sport8dislikeUrl"/>
        <form action="${sport8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121989/81.jpg.html?a=download">2560x1700</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121992/83.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121993/84.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121991/82.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

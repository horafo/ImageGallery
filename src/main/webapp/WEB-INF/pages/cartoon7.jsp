...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121836/71.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon7like" var="cartoon7likeUrl"/>
        <form action="${cartoon7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon7dislike" var="cartoon7dislikeUrl"/>
        <form action="${cartoon7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121836/71.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121837/72.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121838/73.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121839/74.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

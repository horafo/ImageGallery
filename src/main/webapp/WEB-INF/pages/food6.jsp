...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121642/63.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food6like" var="food6likeUrl"/>
        <form action="${food6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food6dislike" var="food6dislikeUrl"/>
        <form action="${food6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121642/63.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121640/61.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121641/62.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121643/64.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118302/001_wallpapersauto_250509_go2loadcom.jpg"  /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto1like" var="auto1likeUrl"/>
        <form action="${auto1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto1dislike" var="auto1dislikeUrl"/>
        <form action="${auto1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118302/001_wallpapersauto_250509_go2loadcom.jpg.html?a=download">1600x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118300/crop.jpg.html?a=download">1440x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118297/__-13.jpg.html?a=download">1200x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118303/porsche-911-gt2-image-06-1024.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/auto1.js.html">

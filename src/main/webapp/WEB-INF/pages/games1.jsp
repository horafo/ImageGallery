...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121553/12.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games1like" var="games1likeUrl"/>
        <form action="${games1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games1dislike" var="games1dislikeUrl"/>
        <form action="${games1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121553/12.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121552/11.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121555/14.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121554/13.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

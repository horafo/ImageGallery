...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121903/53.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature5like" var="nature5likeUrl"/>
        <form action="${nature5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature5dislike" var="nature5dislikeUrl"/>
        <form action="${nature5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121903/53.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121902/52.jpg.html?a=download">1200x800</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121901/51.jpg.html?a=download">1188x792</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121904/54.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118878/74.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto7like" var="auto7likeUrl"/>
        <form action="${auto7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto7dislike" var="auto7dislikeUrl"/>
        <form action="${auto7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118878/74.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118875/71.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118876/72.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118877/73.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

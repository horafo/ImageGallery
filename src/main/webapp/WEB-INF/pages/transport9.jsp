...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122329/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport9like" var="transport9likeUrl"/>
        <form action="${transport9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport9dislike" var="transport9dislikeUrl"/>
        <form action="${transport9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122329/91.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122330/92.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122332/94.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122331/93.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121511/71.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand7like" var="brand7likeUrl"/>
        <form action="${brand7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand7dislike" var="brand7dislikeUrl"/>
        <form action="${brand7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121511/71.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121514/72.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121515/73.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121517/74.jpg.html?a=download ">474x266</a>
                    </li>
                </ul>
            </li>
        </ul>

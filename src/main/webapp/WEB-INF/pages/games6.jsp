...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121572/61.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games6like" var="games6likeUrl"/>
        <form action="${games6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games6dislike" var="games6dislikeUrl"/>
        <form action="${games6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121572/61.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121573/62.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121574/63.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121575/64.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

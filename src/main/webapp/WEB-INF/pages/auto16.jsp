...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118913/161.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto16like" var="auto16likeUrl"/>
        <form action="${auto16likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto16dislike" var="auto16dislikeUrl"/>
        <form action="${auto16dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118913/161.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118915/163.jpg.html?a=download">1600x1000</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118914/162.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118916/164.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121597/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games12like" var="games12likeUrl"/>
        <form action="${games12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games12dislike" var="games12dislikeUrl"/>
        <form action="${games12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121597/121.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121601/123.jpg.html?a=download">1323x567</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121598/122.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121602/124.jpg.html?a=download ">900x505</a>
                    </li>
                </ul>
            </li>
        </ul>

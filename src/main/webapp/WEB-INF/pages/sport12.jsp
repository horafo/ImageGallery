...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122009/122.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport12like" var="sport12likeUrl"/>
        <form action="${sport12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport12dislike" var="sport12dislikeUrl"/>
        <form action="${sport12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122009/122.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122008/121.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122010/123.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122011/124.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122351/142.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport14like" var="transport14likeUrl"/>
        <form action="${transport14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport14dislike" var="transport14dislikeUrl"/>
        <form action="${transport14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122351/142.jpg.html?a=download">2560x1440 </a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122350/141.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122353/144.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122352/143.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

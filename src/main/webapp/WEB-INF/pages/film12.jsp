...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121727/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film12like" var="film12likeUrl"/>
        <form action="${film12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film12dislike" var="film12dislikeUrl"/>
        <form action="${film12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121727/121.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121728/122.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121731/124.jpg.html?a=download">1400x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121729/123.jpg.html?a=download ">1280x853</a>
                    </li>
                </ul>
            </li>
        </ul>

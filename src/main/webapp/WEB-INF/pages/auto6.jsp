...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118871/61.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto6like" var="auto6likeUrl"/>
        <form action="${auto6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto6dislike" var="auto6dislikeUrl"/>
        <form action="${auto6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118871/61.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118872/62.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118873/63.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118874/64.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/auto6.js.html">

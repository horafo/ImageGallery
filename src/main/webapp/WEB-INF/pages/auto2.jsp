...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118853/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto2like" var="auto2likeUrl"/>
        <form action="${auto2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto2dislike" var="auto2dislikeUrl"/>
        <form action="${auto2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118853/21.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118856/23.jpeg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118854/22.jpg.html?a=download">1200x675</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118857/24.jpg.html?a=download ">960x600</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/auto2.js.html">

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119604/72.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture7like" var="architecture7likeUrl"/>
        <form action="${architecture7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture7dislike" var="architecture7dislikeUrl"/>
        <form action="${architecture7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119604/72.jpg.html?a=download">2560x1700</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119603/71.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119606/74.jpg.html?a=download">1440x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119605/73.jpg.html?a=download ">1280x857</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122261/81.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals8like" var="animals8likeUrl"/>
        <form action="${animals8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals8dislike" var="animals8dislikeUrl"/>
        <form action="${animals8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122261/81.jpg.html?a=download">1920x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122265/84.jpg.html?a=download">1600x925</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122264/83.jpg.html?a=download">1200x695</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122262/82.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

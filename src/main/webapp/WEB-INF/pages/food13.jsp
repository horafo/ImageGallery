...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121669/131.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food13like" var="food13likeUrl"/>
        <form action="${food13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food13dislike" var="food13dislikeUrl"/>
        <form action="${food13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121669/131.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121670/132.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121671/133.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121672/134.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

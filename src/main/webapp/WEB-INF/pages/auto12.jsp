...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118895/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto12like" var="auto12likeUrl"/>
        <form action="${auto12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto12dislike" var="auto12dislikeUrl"/>
        <form action="${auto12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118895/121.jpg.html?a=download">2048x1360</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118896/122.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118897/123.jpg.html?a=download">1360x903</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118898/124.jpg.html?a=download ">1200x800</a>
                    </li>
                </ul>
            </li>
        </ul>

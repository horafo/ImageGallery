...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121812/12.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon1like" var="cartoon1likeUrl"/>
        <form action="${cartoon1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon1dislike" var="cartoon1dislikeUrl"/>
        <form action="${cartoon1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121812/12.jpg.html?a=download">2480x1240</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121810/11.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121813/13.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121814/14.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

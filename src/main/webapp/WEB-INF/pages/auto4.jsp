...
<div align="center">
    <a href="#"><img src="http://www.imageup.ru/img226/3118863/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto4like" var="auto4likeUrl"/>
        <form action="${auto4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto4dislike" var="auto4dislikeUrl"/>
        <form action="${auto4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118863/41.jpg.html?a=download">2048x1536</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118865/43.jpg.html?a=download">1600x1067</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118864/42.jpg.html?a=download">1440x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118866/44.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/auto4.js.html">

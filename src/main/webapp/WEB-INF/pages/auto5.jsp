...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118868/52.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto5like" var="auto5likeUrl"/>
        <form action="${auto5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto5dislike" var="auto5dislikeUrl"/>
        <form action="${auto5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118868/52.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118867/51.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118870/54.jpg.html?a=download">1360x903</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118869/53.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/auto5.js.html">

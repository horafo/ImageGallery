...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119594/52.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture5like" var="architecture5likeUrl"/>
        <form action="${architecture5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture5dislike" var="architecture5dislikeUrl"/>
        <form action="${architecture5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119594/52.jpg.html?a=download">3840x2400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119593/51.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119595/53.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119597/54.jpg.html?a=download ">1200x800</a>
                    </li>
                </ul>
            </li>
        </ul>

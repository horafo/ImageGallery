...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122308/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport4like" var="transport4likeUrl"/>
        <form action="${transport4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport4dislike" var="transport4dislikeUrl"/>
        <form action="${transport4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122308/41.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122311/44.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122309/42.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122310/43.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

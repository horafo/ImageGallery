...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119641/161.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture16like" var="architecture16likeUrl"/>
        <form action="${architecture16likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture16dislike" var="architecture16dislikeUrl"/>
        <form action="${architecture16dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119641/161.jpg.html?a=download">1600x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119642/162.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119643/163.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119644/164.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

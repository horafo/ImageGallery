...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121584/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games9like" var="games9likeUrl"/>
        <form action="${games9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games9dislike" var="games9dislikeUrl"/>
        <form action="${games9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121584/91.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121585/92.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121587/94.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121586/93.jpg.html?a=download ">1280x960</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121604/132.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games13like" var="games13likeUrl"/>
        <form action="${games13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games13dislike" var="games13dislikeUrl"/>
        <form action="${games13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121604/132.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121603/131.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121605/133.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121606/134.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

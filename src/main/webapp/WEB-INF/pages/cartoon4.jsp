...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121825/42.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon4like" var="cartoon4likeUrl"/>
        <form action="${cartoon4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon4dislike" var="cartoon4dislikeUrl"/>
        <form action="${cartoon4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121825/42.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121823/41.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121827/44.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121826/43.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

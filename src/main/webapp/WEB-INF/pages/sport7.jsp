...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121985/72.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport7like" var="sport7likeUrl"/>
        <form action="${sport7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport7dislike" var="sport7dislikeUrl"/>
        <form action="${sport7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121985/72.jpg.html?a=download">2880x1800</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121984/71.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121988/74.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121987/73.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121689/31.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film3like" var="film3likeUrl"/>
        <form action="${film3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film3dislike" var="film3dislikeUrl"/>
        <form action="${film3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121689/31.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121692/34.jpeg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121691/33.jpeg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121690/32.jpeg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121493/31.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand3like" var="brand3likeUrl"/>
        <form action="${brand3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand3dislike" var="brand3dislikeUrl"/>
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121493/31.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121496/33.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121497/34.jpg.html?a=download">1150x646</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121494/32.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121799/132.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space13like" var="space13likeUrl"/>
        <form action="${space13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space13dislike" var="space13dislikeUrl"/>
        <form action="${space13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121799/132.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121798/131.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121800/133.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121801/134.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

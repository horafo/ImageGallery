...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121777/82.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space8like" var="space8likeUrl"/>
        <form action="${space8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space8dislike" var="space8dislikeUrl"/>
        <form action="${space8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121777/82.jpg.html?a=download">2560x1400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121776/81.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121779/84.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121778/83.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

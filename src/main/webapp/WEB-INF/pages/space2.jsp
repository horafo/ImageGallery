...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121750/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space2like" var="space2likeUrl"/>
        <form action="${space2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space2dislike" var="space2dislikeUrl"/>
        <form action="${space2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121750/21.jpg.html?a=download">1600x900</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121753/24.jpg.html?a=download">1500x500</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121752/23.jpg.html?a=download">1333x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121751/22.jpg.html?a=download ">1200x675</a>
                    </li>
                </ul>
            </li>
        </ul>

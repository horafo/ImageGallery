...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121712/82.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film8like" var="film8likeUrl"/>
        <form action="${film8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film8dislike" var="film8dislikeUrl"/>
        <form action="${film8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121712/82.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121711/81.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121713/83.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121714/84.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

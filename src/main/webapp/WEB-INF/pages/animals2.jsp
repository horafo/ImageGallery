...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122235/22.jpg" "/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals2like" var="animals2likeUrl"/>
        <form action="${animals2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals2dislike" var="animals2dislikeUrl"/>
        <form action="${animals2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122235/22.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122234/21.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122236/23.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122237/24.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122255/71.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals7like" var="animals7likeUrl"/>
        <form action="${animals7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals7dislike" var="animals7dislikeUrl"/>
        <form action="${animals7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122255/71.jpg.html?a=download">5120x2800</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122257/72.jpg.html?a=download">1920x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122259/74.jpg.html?a=download">1600x875</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122258/73.jpg.html?a=download ">1280x700</a>
                    </li>
                </ul>
            </li>
        </ul>

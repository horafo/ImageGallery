...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121871/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon14like" var="cartoon14likeUrl"/>
        <form action="${cartoon14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon14dislike" var="cartoon14dislikeUrl"/>
        <form action="${cartoon14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121871/141.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121874/144.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121873/143.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121872/142.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

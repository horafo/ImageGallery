...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122291/151.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals15like" var="animals15likeUrl"/>
        <form action="${animals15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals15dislike" var="animals15dislikeUrl"/>
        <form action="${animals15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122291/151.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122292/152.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122294/154.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122293/153.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

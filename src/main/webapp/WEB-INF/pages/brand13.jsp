...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121540/131.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand13like" var="brand13likeUrl"/>
        <form action="${brand13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand13dislike" var="brand13dislikeUrl"/>
        <form action="${brand13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121540/131.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121543/134.jpg.html?a=download">1024x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121542/133.jpg.html?a=download">800x500</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121541/132.jpg.html?a=download ">640x400</a>
                    </li>
                </ul>
            </li>
        </ul>

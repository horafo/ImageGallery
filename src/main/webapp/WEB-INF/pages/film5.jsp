...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121698/51.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film5like" var="film5likeUrl"/>
        <form action="${film5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film5dislike" var="film5dislikeUrl"/>
        <form action="${film5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121698/51.jpg.html?a=download">2048x1493</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121700/53.jpg.html?a=download">1400x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121701/54.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121699/52.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

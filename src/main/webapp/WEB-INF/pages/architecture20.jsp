...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119661/204.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture20like" var="architecture20likeUrl"/>
        <form action="${architecture20likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture20dislike" var="architecture20dislikeUrl"/>
        <form action="${architecture20dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119661/204.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119658/201.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119659/202.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119660/203.jpg.html?a=download ">1366x768</a>
                    </li>
                </ul>
            </li>
        </ul>

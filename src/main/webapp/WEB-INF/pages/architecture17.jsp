...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119645/171.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture17like" var="architecture17likeUrl"/>
        <form action="${architecture17likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture17dislike" var="architecture17dislikeUrl"/>
        <form action="${architecture17dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119645/171.jpg.html?a=download">4272x2848</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119647/173.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119648/174.jpg.html?a=download">1600x1067</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119646/172.jpg.html?a=download ">1280x853</a>
                    </li>
                </ul>
            </li>
        </ul>

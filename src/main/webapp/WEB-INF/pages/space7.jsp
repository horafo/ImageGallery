...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121771/71.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space7like" var="space7likeUrl"/>
        <form action="${space7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space7dislike" var="space7dislikeUrl"/>
        <form action="${space7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121771/71.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121774/74.jpg.html?a=download">1600x1000</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121773/73.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121772/72.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

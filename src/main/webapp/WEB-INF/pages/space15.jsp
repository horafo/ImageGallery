...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121807/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space15like" var="space15likeUrl"/>
        <form action="${space15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space15dislike" var="space15dislikeUrl"/>
        <form action="${space15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121807/152.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121806/151.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121808/153.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121809/154.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

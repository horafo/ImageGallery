...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121910/72.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature7like" var="nature7likeUrl"/>
        <form action="${nature7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature7dislike" var="nature7dislikeUrl"/>
        <form action="${nature7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121910/72.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121909/71.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121911/73.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121913/74.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

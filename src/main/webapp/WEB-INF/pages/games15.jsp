...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121613/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games15like" var="games15likeUrl"/>
        <form action="${games15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games15dislike" var="games15dislikeUrl"/>
        <form action="${games15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121613/152.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121612/151.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121614/153.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121615/154.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

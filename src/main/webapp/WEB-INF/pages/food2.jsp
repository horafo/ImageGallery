...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121620/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food2like" var="food2likeUrl"/>
        <form action="${food2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food2dislike" var="food2dislikeUrl"/>
        <form action="${food2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121620/21.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121622/24.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121621/22.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121626/23.jpg.html?a=download ">720x405</a>
                    </li>
                </ul>
            </li>
        </ul>

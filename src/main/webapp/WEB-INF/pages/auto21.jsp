...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118957/214.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto21like" var="auto21likeUrl"/>
        <form action="${auto21likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto21dislike" var="auto21dislikeUrl"/>
        <form action="${auto21dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118957/214.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118954/211.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118955/212.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118956/213.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

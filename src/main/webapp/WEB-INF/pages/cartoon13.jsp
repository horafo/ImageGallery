...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121866/131.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon13like" var="cartoon13likeUrl"/>
        <form action="${cartoon13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon13dislike" var="cartoon13dislikeUrl"/>
        <form action="${cartoon13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121866/131.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121869/133.jpg.html?a=download">1400x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121870/134.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121867/132.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/cartoon1.js.html">

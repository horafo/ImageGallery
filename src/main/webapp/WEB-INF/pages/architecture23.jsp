...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119670/231.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture23like" var="architecture23likeUrl"/>
        <form action="${architecture23likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture23dislike" var="architecture23dislikeUrl"/>
        <form action="${architecture23dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119670/231.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119671/232.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119673/234.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119673/234.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

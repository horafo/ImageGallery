...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121645/72.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food7like" var="food7likeUrl"/>
        <form action="${food7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food7dislike" var="food7dislikeUrl"/>
        <form action="${food7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121645/72.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121644/71.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121646/73.jpg.html?a=download">1200x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121647/74.jpg.html?a=download ">1000x640</a>
                    </li>
                </ul>
            </li>
        </ul>

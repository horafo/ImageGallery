...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121746/12.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space1like" var="space1likeUrl"/>
        <form action="${space1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space1dislike" var="space1dislikeUrl"/>
        <form action="${space1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121746/12.jpg.html?a=download">2048x1536</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121745/11.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121749/14.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121748/13.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

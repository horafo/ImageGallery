...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118995/301.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto30like" var="auto30likeUrl"/>
        <form action="${auto30likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto30dislike" var="auto30dislikeUrl"/>
        <form action="${auto30dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118995/301.jpg.html?a=download">3040x2026</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118998/304.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118997/303.jpg.html?a=download">1600x1066</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118996/302.jpg.html?a=download ">1280x852</a>
                    </li>
                </ul>
            </li>
        </ul>

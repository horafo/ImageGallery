...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121820/32.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon3like" var="cartoon3likeUrl"/>
        <form action="${cartoon3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon3dislike" var="cartoon3dislikeUrl"/>
        <form action="${cartoon3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121820/32.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121819/31.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121822/34.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121821/33.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121677/151.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food15like" var="food15likeUrl"/>
        <form action="${food15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food15dislike" var="food15dislikeUrl"/>
        <form action="${food15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121677/151.jpg.html?a=download">2560x1667</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121678/152.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121679/153.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121680/154.jpg.html?a=download ">1024x683</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121685/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film2like" var="film2likeUrl"/>
        <form action="${film2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film2dislike" var="film2dislikeUrl"/>
        <form action="${film2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121685/21.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121686/22.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121688/24.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121687/23.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

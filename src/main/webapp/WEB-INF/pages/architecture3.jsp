...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119583/31.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture3like" var="architecture3likeUrl"/>
        <form action="${architecture3likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture3dislike" var="architecture3dislikeUrl"/>
        <form action="${architecture3dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119583/31.jpg.html?a=download">2560x1700</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119584/32.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119585/33.jpg.html?a=download">1280x853</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119586/34.jpg.html?a=download ">1024x683</a>
                    </li>
                </ul>
            </li>
        </ul>

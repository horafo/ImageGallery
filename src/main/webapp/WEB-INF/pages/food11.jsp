...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121662/112.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food11like" var="food11likeUrl"/>
        <form action="${food11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food11dislike" var="food11dislikeUrl"/>
        <form action="${food11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121662/112.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121661/111.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121664/114.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121663/113.jpg.html?a=download ">1200x750</a>
                    </li>
                </ul>
            </li>
        </ul>

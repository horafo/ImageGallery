...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121954/12.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport1like" var="sport1likeUrl"/>
        <form action="${sport1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport1dislike" var="sport1dislikeUrl"/>
        <form action="${sport1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121954/12.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121953/11.jpg.html?a=download">1920x1240</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121955/13.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121956/14.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

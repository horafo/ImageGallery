...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121503/51.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand5like" var="brand5likeUrl"/>
        <form action="${brand5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand5dislike" var="brand5dislikeUrl"/>
        <form action="${brand5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121503/51.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121504/52.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121505/53.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121506/54.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

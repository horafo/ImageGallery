...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118884/92.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto9like" var="auto9likeUrl"/>
        <form action="${auto9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto9dislike" var="auto9dislikeUrl"/>
        <form action="${auto9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118884/92.jpg.html?a=download">3840x2400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118883/91.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118886/94.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118885/93.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122231/12.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals1like" var="animals1likeUrl"/>
        <form action="${animals1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals1dislike" var="animals1dislikeUrl"/>
        <form action="${animals1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122231/12.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122230/11.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122232/13.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122233/14.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121789/111.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space11like" var="space11likeUrl"/>
        <form action="${space11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space11dislike" var="space11dislikeUrl"/>
        <form action="${space11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121789/111.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121792/114.jpg.html?a=download">1735x1085</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121790/112.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121791/113.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122295/11.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport1like" var="transport1likeUrl"/>
        <form action="${transport1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport1dislike" var="transport1dislikeUrl"/>
        <form action="${transport1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122295/11.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122296/12.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122297/13.jpg.html?a=download">854x480</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122298/14.jpg.html?a=download ">768x614</a>
                    </li>
                </ul>
            </li>
        </ul>

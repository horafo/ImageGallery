...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121905/61.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature6like" var="nature6likeUrl"/>
        <form action="${nature6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature6dislike" var="nature6dislikeUrl"/>
        <form action="${nature6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121905/61.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121907/63.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121908/64.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121906/62.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

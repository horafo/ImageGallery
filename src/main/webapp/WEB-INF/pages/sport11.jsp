...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122004/111.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport11like" var="sport11likeUrl"/>
        <form action="${sport11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport11dislike" var="sport11dislikeUrl"/>
        <form action="${sport11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122004/111.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122007/114.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122005/112.jpg.html?a=download">1200x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122006/113.jpg.html?a=download ">1024x683</a>
                    </li>
                </ul>
            </li>
        </ul>

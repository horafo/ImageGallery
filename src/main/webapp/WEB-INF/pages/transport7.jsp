...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122321/71.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport7like" var="transport7likeUrl"/>
        <form action="${transport7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport7dislike" var="transport7dislikeUrl"/>
        <form action="${transport7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122321/71.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122322/72.jpg.html?a=download">1600x1067</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122323/73.jpg.html?a=download">1200x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122324/74.jpg.html?a=download ">1030x488</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122346/132.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport13like" var="transport13likeUrl"/>
        <form action="${transport13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport13dislike" var="transport13dislikeUrl"/>
        <form action="${transport13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122346/132.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122345/131.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122348/133.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122349/134.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

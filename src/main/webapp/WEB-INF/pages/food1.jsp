...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121616/11.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food1like" var="food1likeUrl"/>
        <form action="${food1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food1dislike" var="food1dislikeUrl"/>
        <form action="${food1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121616/11.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121617/12.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121619/14.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121618/13.jpg.html?a=download ">1000x625</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121919/92.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature9like" var="nature9likeUrl"/>
        <form action="${nature9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature9dislike" var="nature9dislikeUrl"/>
        <form action="${nature9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121919/92.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121918/91.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121921/94.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121920/93.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119625/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture12like" var="architecture12likeUrl"/>
        <form action="${architecture12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture12dislike" var="architecture12dislikeUrl"/>
        <form action="${architecture12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119625/121.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119626/122.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119627/123.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119628/124.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

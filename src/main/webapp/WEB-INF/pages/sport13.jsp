...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122014/132.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport13like" var="sport13likeUrl"/>
        <form action="${sport13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport13dislike" var="sport13dislikeUrl"/>
        <form action="${sport13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122014/132.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122012/131.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122016/134.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122015/133.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

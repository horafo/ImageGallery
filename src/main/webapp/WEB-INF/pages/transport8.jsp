...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122325/81.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport8like" var="transport8likeUrl"/>
        <form action="${transport8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport8dislike" var="transport8dislikeUrl"/>
        <form action="${transport8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122325/81.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122326/82.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122328/84.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122327/83.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

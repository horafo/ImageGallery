...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121893/42.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature4like" var="nature4likeUrl"/>
        <form action="${nature4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature4dislike" var="nature4dislikeUrl"/>
        <form action="${nature4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121893/42.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121892/41.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121894/43.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121895/44.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

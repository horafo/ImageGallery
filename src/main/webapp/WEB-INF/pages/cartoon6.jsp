...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121833/62.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon6like" var="cartoon6likeUrl"/>
        <form action="${cartoon6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon6dislike" var="cartoon6dislikeUrl"/>
        <form action="${cartoon6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121833/62.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121832/61.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121835/64.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121834/63.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118909/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto15like" var="auto15likeUrl"/>
        <form action="${auto15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto15dislike" var="auto15dislikeUrl"/>
        <form action="${auto15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118909/152.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118908/151.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118911/154.jpg.html?a=download">1600x1000</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119144/153.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

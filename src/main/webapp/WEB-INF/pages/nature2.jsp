...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121885/22.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature2like" var="nature2likeUrl"/>
        <form action="${nature2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature2dislike" var="nature2dislikeUrl"/>
        <form action="${nature2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121885/22.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121884/21.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121887/24.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121886/23.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118968/241.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto24like" var="auto24likeUrl"/>
        <form action="${auto24likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto24dislike" var="auto24dislikeUrl"/>
        <form action="${auto24dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118968/241.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118970/243.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118971/244.jpg.html?a=download">1600x1000</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118969/242.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

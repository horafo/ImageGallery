...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118950/201.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto20like" var="auto20likeUrl"/>
        <form action="${auto20likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto20dislike" var="auto20dislikeUrl"/>
        <form action="${auto20dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118950/201.jpg.html?a=download">3840x2400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118953/204.jpg.html?a=download">2560x1600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118951/202.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118952/203.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

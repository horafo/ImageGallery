...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121523/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand9like" var="brand9likeUrl"/>
        <form action="${brand9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand9dislike" var="brand9dislikeUrl"/>
        <form action="${brand9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121523/91.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121524/92.jpg.html?a=download">1060x600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121526/93.jpg.html?a=download">825x550</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121527/94.jpg.html?a=download ">720x400</a>
                    </li>
                </ul>
            </li>
        </ul>

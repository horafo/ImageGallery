...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121927/112.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature11like" var="nature11likeUrl"/>
        <form action="${nature11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature11dislike" var="nature11dislikeUrl"/>
        <form action="${nature11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121926/111.jpg.jpg.html?a=download">3000x2000</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121927/112.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121929/113.jpg.html?a=download">1024x683</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121930/114.jpg.html?a=download ">807x538</a>
                    </li>
                </ul>
            </li>
        </ul>

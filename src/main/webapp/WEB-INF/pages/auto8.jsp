...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118882/84.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto8like" var="auto8likeUrl"/>
        <form action="${auto8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto8dislike" var="auto8dislikeUrl"/>
        <form action="${auto8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118882/84.jpg.html?a=download">2048x1400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118879/81.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118881/83.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118880/82.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

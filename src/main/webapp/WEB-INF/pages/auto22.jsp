...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118958/221.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto22like" var="auto22likeUrl"/>
        <form action="${auto22likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto22dislike" var="auto22dislikeUrl"/>
        <form action="${auto22dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118958/221.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118959/222.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118960/223.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118961/224.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

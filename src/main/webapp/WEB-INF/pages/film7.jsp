...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121707/71.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film7like" var="film7likeUrl"/>
        <form action="${film7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film7dislike" var="film7dislikeUrl"/>
        <form action="${film7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121707/71.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121708/72.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121709/73.jpg.html?a=download">1440x900  </a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121710/74.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

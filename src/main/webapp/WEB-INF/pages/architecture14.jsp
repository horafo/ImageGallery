...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119633/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture14like" var="architecture14likeUrl"/>
        <form action="${architecture14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture14dislike" var="architecture14dislikeUrl"/>
        <form action="${architecture14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119633/141.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119636/144.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119634/142.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119635/143.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

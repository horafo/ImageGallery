...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121528/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand10like" var="brand10likeUrl"/>
        <form action="${brand10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand10dislike" var="brand10dislikeUrl"/>
        <form action="${brand10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121528/101.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121529/102.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121531/104.jpg.html?a=download">1280x960</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121530/103.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

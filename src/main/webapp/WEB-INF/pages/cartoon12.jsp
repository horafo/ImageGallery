...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121862/121.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon12like" var="cartoon12likeUrl"/>
        <form action="${cartoon12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon12dislike" var="cartoon12dislikeUrl"/>
        <form action="${cartoon12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121862/121.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121863/122.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121865/124.jpg.html?a=download">1320x742</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121864/123.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

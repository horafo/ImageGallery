...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121653/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food9like" var="food9likeUrl"/>
        <form action="${food9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food9dislike" var="food9dislikeUrl"/>
        <form action="${food9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121653/91.jpg.html?a=download">2880x1800</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121654/92.jpeg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121655/93.jpg.html?a=download">1200x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121656/94.jpg.html?a=download ">284x177</a>
                    </li>
                </ul>
            </li>
        </ul>

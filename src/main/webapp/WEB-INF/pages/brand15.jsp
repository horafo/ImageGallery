...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121549/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand15like" var="brand15likeUrl"/>
        <form action="${brand15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand15dislike" var="brand15dislikeUrl"/>
        <form action="${brand15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121549/152.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121548/151.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121550/153.jpg.html?a=download">1024x576</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121551/154.jpg.html?a=download ">800x600</a>
                    </li>
                </ul>
            </li>
        </ul>

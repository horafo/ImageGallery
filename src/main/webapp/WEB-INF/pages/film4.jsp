...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121693/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film4like" var="film4likeUrl"/>
        <form action="${film4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film4dislike" var="film4dislikeUrl"/>
        <form action="${film4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121693/41.jpg.html?a=download">1920x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121695/43.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121696/44.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121694/42.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

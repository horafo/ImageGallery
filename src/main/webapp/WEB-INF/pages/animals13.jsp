...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122283/131.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals13like" var="animals13likeUrl"/>
        <form action="${animals13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals13dislike" var="animals13dislikeUrl"/>
        <form action="${animals13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122283/131.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122284/132.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122286/134.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122285/133.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

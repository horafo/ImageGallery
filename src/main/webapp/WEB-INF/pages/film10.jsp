...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121719/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film10like" var="film10likeUrl"/>
        <form action="${film10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film10dislike" var="film10dislikeUrl"/>
        <form action="${film10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121719/101.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121721/103.jpg.html?a=download">2048x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121720/102.jpg.html?a=download">1280x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121722/104.jpg.html?a=download ">1024x576</a>
                    </li>
                </ul>
            </li>
        </ul>

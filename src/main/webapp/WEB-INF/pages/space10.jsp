...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121785/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space10like" var="space10likeUrl"/>
        <form action="${space10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space10dislike" var="space10dislikeUrl"/>
        <form action="${space10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121785/101.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121786/102.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121787/103.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121788/104.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

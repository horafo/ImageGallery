...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121637/52.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food5like" var="food5likeUrl"/>
        <form action="${food5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food5dislike" var="food5dislikeUrl"/>
        <form action="${food5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121637/52.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121636/51.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121639/54.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121638/53.jpeg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

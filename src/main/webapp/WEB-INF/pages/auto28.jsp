...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118987/281.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto28like" var="auto28likeUrl"/>
        <form action="${auto28likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto28dislike" var="auto28dislikeUrl"/>
        <form action="${auto28dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118987/281.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118988/282.jpg.html?a=download">1680x1050</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118989/283.jpg.html?a=download">1200x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118990/284.jpg.html?a=download ">1024x615</a>
                    </li>
                </ul>
            </li>
        </ul>

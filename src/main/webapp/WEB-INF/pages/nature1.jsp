...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121880/12.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature1like" var="nature1likeUrl"/>
        <form action="${nature1likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature1dislike" var="nature1dislikeUrl"/>
        <form action="${nature1dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121880/12.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121879/11.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121882/13.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121883/14.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

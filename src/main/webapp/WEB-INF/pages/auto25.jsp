...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118974/251.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto25like" var="auto25likeUrl"/>
        <form action="${auto25likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto25dislike" var="auto25dislikeUrl"/>
        <form action="${auto25dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118974/251.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118975/252.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118976/253.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118977/254.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118983/271.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto27like" var="auto27likeUrl"/>
        <form action="${auto27likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto27dislike" var="auto27dislikeUrl"/>
        <form action="${auto27dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118983/271.jpg.html?a=download">1920x1280</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118986/274.jpg.html?a=download">1600x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118984/272.jpg.html?a=download">1200x800</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118985/273.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

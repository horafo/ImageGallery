...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122333/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport10like" var="transport10likeUrl"/>
        <form action="${transport10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport10dislike" var="transport10dislikeUrl"/>
        <form action="${transport10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122333/101.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122335/103.jpg.html?a=download">1200x600</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122334/102.jpg.html?a=download">1024x505  </a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122336/104.jpg.html?a=download ">900x411</a>
                    </li>
                </ul>
            </li>
        </ul>

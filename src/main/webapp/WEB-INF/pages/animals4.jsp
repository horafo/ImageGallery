...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122242/41.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals4like" var="animals4likeUrl"/>
        <form action="${animals4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals4dislike" var="animals4dislikeUrl"/>
        <form action="${animals4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122242/41.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122243/42.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122245/44.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122244/43.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

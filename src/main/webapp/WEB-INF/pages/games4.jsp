...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121564/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games4like" var="games4likeUrl"/>
        <form action="${games4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games4dislike" var="games4dislikeUrl"/>
        <form action="${games4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121564/41.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121565/42.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121567/44.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121566/43.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

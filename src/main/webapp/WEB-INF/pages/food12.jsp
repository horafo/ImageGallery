...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121666/122.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food12like" var="food12likeUrl"/>
        <form action="${food12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food12dislike" var="food12dislikeUrl"/>
        <form action="${food12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121666/122.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121665/121.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121668/124.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121667/123.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

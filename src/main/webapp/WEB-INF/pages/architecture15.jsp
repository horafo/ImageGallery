...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119637/151.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture15like" var="architecture15likeUrl"/>
        <form action="${architecture15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture15dislike" var="architecture15dislikeUrl"/>
        <form action="${architecture15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119637/151.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119640/154.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119638/152.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119639/153.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121732/131.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film13like" var="film13likeUrl"/>
        <form action="${film13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film13dislike" var="film13dislikeUrl"/>
        <form action="${film13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121732/131.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121733/132.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121735/134.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121734/133.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

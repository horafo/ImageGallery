...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118891/111.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto11like" var="auto11likeUrl"/>
        <form action="${auto11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto11dislike" var="auto11dislikeUrl"/>
        <form action="${auto11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118891/111.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118892/112.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118894/114.jpg.html?a=download">1200x630</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118893/113.jpg.html?a=download ">1024x639</a>
                    </li>
                </ul>
            </li>
        </ul>

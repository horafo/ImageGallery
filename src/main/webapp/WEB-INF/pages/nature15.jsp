...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121949/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature15like" var="nature15likeUrl"/>
        <form action="${nature15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature15dislike" var="nature15dislikeUrl"/>
        <form action="${nature15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121949/152.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121948/151.jpg.html?a=download">1920x108  0</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121950/153.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121951/154.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

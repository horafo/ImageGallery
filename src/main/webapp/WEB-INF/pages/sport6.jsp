...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121979/61.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport6like" var="sport6likeUrl"/>
        <form action="${sport6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport6dislike" var="sport6dislikeUrl"/>
        <form action="${sport6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121979/61.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121982/64.jpg.html?a=download">1500x500</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121980/62.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121981/63.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

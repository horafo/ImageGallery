...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121673/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food14like" var="food14likeUrl"/>
        <form action="${food14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food14dislike" var="food14dislikeUrl"/>
        <form action="${food14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121673/141.jpg.html?a=download">2880x1800</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121674/142.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121676/144.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121675/143.jpg.html?a=download ">1200x750</a>
                    </li>
                </ul>
            </li>
        </ul>

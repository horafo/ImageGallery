...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121577/72.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games7like" var="games7likeUrl"/>
        <form action="${games7likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games7dislike" var="games7dislikeUrl"/>
        <form action="${games7dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121577/72.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121576/71.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121578/73.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121579/74.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

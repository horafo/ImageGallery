...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121944/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature14like" var="nature14likeUrl"/>
        <form action="${nature14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature14dislike" var="nature14dislikeUrl"/>
        <form action="${nature14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121944/141.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121945/142.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121947/144.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121946/143.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

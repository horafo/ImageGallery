...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121594/112.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games11like" var="games11likeUrl"/>
        <form action="${games11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games11dislike" var="games11dislikeUrl"/>
        <form action="${games11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121594/112.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121592/111.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121595/113.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121596/114.jpg.html?a=download ">1024x768</a>
                    </li>
                </ul>
            </li>
        </ul>

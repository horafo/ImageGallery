...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122246/51.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals5like" var="animals5likeUrl"/>
        <form action="${animals5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals5dislike" var="animals5dislikeUrl"/>
        <form action="${animals5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122246/51.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122247/52.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122249/54.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122248/53.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

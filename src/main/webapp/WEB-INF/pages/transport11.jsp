...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122338/112.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport11like" var="transport11likeUrl"/>
        <form action="${transport11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport11dislike" var="transport11dislikeUrl"/>
        <form action="${transport11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122338/112.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122337/111.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122340/114.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122339/113.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

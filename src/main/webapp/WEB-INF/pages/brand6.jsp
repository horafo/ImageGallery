...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121507/61.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand6like" var="brand6likeUrl"/>
        <form action="${brand6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand6dislike" var="brand6dislikeUrl"/>
        <form action="${brand6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121507/61.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121509/63.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121508/62.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121510/64.jpg.html?a=download ">1280x1024</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121875/151.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon15like" var="cartoon15likeUrl"/>
        <form action="${cartoon15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon15dislike" var="cartoon15dislikeUrl"/>
        <form action="${cartoon15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121875/151.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121876/152.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121878/154.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121877/153.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119616/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture10like" var="architecture10likeUrl"/>
        <form action="${architecture10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture10dislike" var="architecture10dislikeUrl"/>
        <form action="${architecture10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119616/101.jpg.html?a=download">2048x1367</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119617/102.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119619/103.jpg.html?a=download">1280x854</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119620/104.jpg.html?a=download ">1000x667</a>
                    </li>
                </ul>
            </li>
        </ul>

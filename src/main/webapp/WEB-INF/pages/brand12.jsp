...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121536/121.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand12like" var="brand12likeUrl"/>
        <form action="${brand12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand12dislike" var="brand12dislikeUrl"/>
        <form action="${brand12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121536/121.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121538/123.jpg.html?a=download">1024x1024</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121537/122.jpg.html?a=download">1024x600</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121539/124.jpg.html?a=download ">807x454</a>
                    </li>
                </ul>
            </li>
        </ul>

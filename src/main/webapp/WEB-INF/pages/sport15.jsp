...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122021/151.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport15like" var="sport15likeUrl"/>
        <form action="${sport15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport15dislike" var="sport15dislikeUrl"/>
        <form action="${sport15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122021/151.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122022/152.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122023/153.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122024/154.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

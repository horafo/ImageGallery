...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119667/222.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture22like" var="architecture22likeUrl"/>
        <form action="${architecture22likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture22dislike" var="architecture22dislikeUrl"/>
        <form action="${architecture22dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119667/222.jpg.html?a=download">3840x2160</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119666/221.jpg.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119669/224.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119668/223.jpg.html?a=download ">1280x853</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div align="center">
    <div class="social-likes" data-url="file:///C:/Users/Администратор/Desktop/Bootstrap/15/architecture1.js.html">

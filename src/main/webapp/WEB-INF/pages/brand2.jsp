...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121489/21.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand2like" var="brand2likeUrl"/>
        <form action="${brand2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand2dislike" var="brand2dislikeUrl"/>
        <form action="${brand2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121489/21.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121492/24.jpg.html?a=download">1500x500</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121490/22.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121491/23.jpg.html?a=download ">1024x552</a>
                    </li>
                </ul>
            </li>
        </ul>

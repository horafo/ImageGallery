...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118900/131.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto13like" var="auto13likeUrl"/>
        <form action="${auto13likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto13dislike" var="auto13dislikeUrl"/>
        <form action="${auto13dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118900/131.jpg.html?a=download">3000x2000</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118888/102.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118903/134.jpg.html?a=download">1200x750</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118902/133.jpg.html?a=download ">1024x600</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121998/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport10like" var="sport10likeUrl"/>
        <form action="${sport10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport10dislike" var="sport10dislikeUrl"/>
        <form action="${sport10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121998/101.jpg.html?a=download">3840x2400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122001/102.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img42/3130160/104.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122002/103.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

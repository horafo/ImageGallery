...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122250/61.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals6like" var="animals6likeUrl"/>
        <form action="${animals6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals6dislike" var="animals6dislikeUrl"/>
        <form action="${animals6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122250/61.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122251/62.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122252/63.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122254/64.jpg.html?a=download ">1024x640</a>
                    </li>
                </ul>
            </li>
        </ul>

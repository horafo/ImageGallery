...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121974/52.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport5like" var="sport5likeUrl"/>
        <form action="${sport5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport5dislike" var="sport5dislikeUrl"/>
        <form action="${sport5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121974/52.jpg.html?a=download">2560x1400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121972/51.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121977/54.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121976/53.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118963/231.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto23like" var="auto23likeUrl"/>
        <form action="${auto23likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto23dislike" var="auto23dislikeUrl"/>
        <form action="${auto23dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118963/231.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118964/232.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118966/233.jpg.html?a=download">1280x720</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118967/234.jpg.html?a=download ">940x500</a>
                    </li>
                </ul>
            </li>
        </ul>

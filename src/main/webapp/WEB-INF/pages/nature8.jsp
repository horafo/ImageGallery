...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121915/82.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature8like" var="nature8likeUrl"/>
        <form action="${nature8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature8dislike" var="nature8dislikeUrl"/>
        <form action="${nature8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121915/82.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121914/81.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121916/83.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121917/84.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

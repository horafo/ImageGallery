...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121702/61.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film6like" var="film6likeUrl"/>
        <form action="${film6likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film6dislike" var="film6dislikeUrl"/>
        <form action="${film6dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121702/61.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121703/62.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121705/64.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121704/63.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

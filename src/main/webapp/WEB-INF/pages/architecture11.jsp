...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3119621/111.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/architecture11like" var="architecture11likeUrl"/>
        <form action="${architecture11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/architecture11dislike" var="architecture11dislikeUrl"/>
        <form action="${architecture11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3119621/111.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119622/112.jpg.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3119624/114.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3119623/113.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

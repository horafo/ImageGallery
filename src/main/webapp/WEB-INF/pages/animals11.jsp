...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122276/112.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/animals11like" var="animals11likeUrl"/>
        <form action="${animals11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/animals11dislike" var="animals11dislikeUrl"/>
        <form action="${animals11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122276/112.jpg.html?a=download">2880x1800</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122275/111.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122278/114.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122277/113.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121857/111.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon11like" var="cartoon11likeUrl"/>
        <form action="${cartoon11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon11dislike" var="cartoon11dislikeUrl"/>
        <form action="${cartoon11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121857/111.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121858/112.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121860/114.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121859/113.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121762/51.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space5like" var="space5likeUrl"/>
        <form action="${space5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space5dislike" var="space5dislikeUrl"/>
        <form action="${space5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121762/51.jpg.html?a=download">1920x1200</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121764/53.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121763/52.jpg.html?a=download">1024x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121765/54.jpg.html?a=download ">960x540</a>
                    </li>
                </ul>
            </li>
        </ul>

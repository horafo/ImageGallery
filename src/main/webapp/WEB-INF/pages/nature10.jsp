...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121922/101.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/nature10like" var="nature10likeUrl"/>
        <form action="${nature10likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/nature10dislike" var="nature10dislikeUrl"/>
        <form action="${nature10dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121922/101.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121923/102.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121924/103.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121925/104.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

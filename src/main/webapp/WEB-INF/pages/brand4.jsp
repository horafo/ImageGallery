...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121498/41.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/brand4like" var="brand4likeUrl"/>
        <form action="${brand4likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/brand4dislike" var="brand4dislikeUrl"/>
        <form action="${brand4dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121498/41.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121500/42.jpg.html?a=download">1024x768</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121501/43.jpg.html?a=download">960x491</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121502/44.jpg.html?a=download ">400x250</a>
                    </li>
                </ul>
            </li>
        </ul>

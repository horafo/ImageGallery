...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121828/51.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/cartoon5like" var="cartoon5likeUrl"/>
        <form action="${cartoon5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/cartoon5dislike" var="cartoon5dislikeUrl"/>
        <form action="${cartoon5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121828/51.jpg.html?a=download">2400x1350</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121829/52.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121830/53.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121831/54.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

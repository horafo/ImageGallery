...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121995/92.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/sport9like" var="sport9likeUrl"/>
        <form action="${sport9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/sport9dislike" var="sport9dislikeUrl"/>
        <form action="${sport9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121995/92.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121994/91.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121997/94.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121996/93.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

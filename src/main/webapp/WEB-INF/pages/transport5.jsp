...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122312/51.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport5like" var="transport5likeUrl"/>
        <form action="${transport5likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport5dislike" var="transport5dislikeUrl"/>
        <form action="${transport5dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122312/51.jpg.html?a=download">1920x1080</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122315/54.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122314/53.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122313/52.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

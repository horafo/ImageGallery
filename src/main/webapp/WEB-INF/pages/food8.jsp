...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121649/82.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/food8like" var="food8likeUrl"/>
        <form action="${food8likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/food8dislike" var="food8dislikeUrl"/>
        <form action="${food8dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121649/82.jpg.html?a=download">2560x1700</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121648/81.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121652/84.jpg.html?a=download">1600x1063</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121651/83.jpg.html?a=download ">1280x850</a>
                    </li>
                </ul>
            </li>
        </ul>

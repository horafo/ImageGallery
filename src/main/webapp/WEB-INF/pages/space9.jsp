...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121780/91.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space9like" var="space9likeUrl"/>
        <form action="${space9likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space9dislike" var="space9dislikeUrl"/>
        <form action="${space9dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121780/91.jpg.html?a=download">3840x2400</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121781/92.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121782/93.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121784/94.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>

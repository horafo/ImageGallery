...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121556/21.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/games2like" var="games2likeUrl"/>
        <form action="${games2likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/games2dislike" var="games2dislikeUrl"/>
        <form action="${games2dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121556/21.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121557/22.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121558/23.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121559/24.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121797/124.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/space12like" var="space12likeUrl"/>
        <form action="${space12likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/space12dislike" var="space12dislikeUrl"/>
        <form action="${space12dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121797/124.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121794/122.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121793/121.jpg.html?a=download">1600x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121795/123.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

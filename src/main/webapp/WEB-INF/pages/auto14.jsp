...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118904/141.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto14like" var="auto14likeUrl"/>
        <form action="${auto14likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto14dislike" var="auto14dislikeUrl"/>
        <form action="${auto14dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118904/141.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118905/142.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118907/144.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118906/143.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

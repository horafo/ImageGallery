...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118921/181.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto18like" var="auto18likeUrl"/>
        <form action="${auto18likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto18dislike" var="auto18dislikeUrl"/>
        <form action="${auto18dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118921/181.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118922/182.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118923/183.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118924/184.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3121723/111.jpg"/></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/film11like" var="film11likeUrl"/>
        <form action="${film11likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/film11dislike" var="film11dislikeUrl"/>
        <form action="${film11dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3121723/111.jpg.html?a=download">2560x1600</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121724/112.jpg.html?a=download">1920x1280</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3121726/114.jpg.html?a=download">1400x934</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3121725/113.jpg.html?a=download ">1280x853</a>
                    </li>
                </ul>
            </li>
        </ul>

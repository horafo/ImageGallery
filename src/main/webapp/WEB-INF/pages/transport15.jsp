...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img143/3122355/152.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/transport15like" var="transport15likeUrl"/>
        <form action="${transport15likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/transport15dislike" var="transport15dislikeUrl"/>
        <form action="${transport15dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img143/3122355/152.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122354/151.jpg.html?a=download">1920x1080</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img143/3122356/153.jpg.html?a=download">1366x768</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img143/3122357/154.jpg.html?a=download ">1280x720</a>
                    </li>
                </ul>
            </li>
        </ul>

...
<div class="gallery">
    <a href="#"><img src="http://www.imageup.ru/img226/3118991/291.jpg" /></a>
...
<div class="container-fluid" id="container">
    <div align="center">
        ...
        <c:url value="/auto29like" var="auto29likeUrl"/>
        <form action="${auto29likeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <c:url value="/auto29dislike" var="auto29dislikeUrl"/>
        <form action="${auto29dislikeUrl}" method="POST" class="navbar-form navbar-left">
        ...
        <ul class="nav navbar-nav ">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu ">
                    <li>
                        <a href="http://www.imageup.ru/img226/3118991/291.jpg.html?a=download">2560x1440</a>
                    </li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118992/292.jpg.html?a=download">1920x1200</a></li>
                    <li class="divider"></li>
                    <li><a href="http://www.imageup.ru/img226/3118994/294.jpg.html?a=download">1440x900</a></li>
                    <li class="divider"></li>
                    <li>
                        <a href="http://www.imageup.ru/img226/3118993/293.jpg.html?a=download ">1280x800</a>
                    </li>
                </ul>
            </li>
        </ul>
